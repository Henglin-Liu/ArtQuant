...
class MPLUGOwl2Config(LlamaConfig):
    ...
    def __setitem__(self, key, value):
        assert key == "multi_scale" or key == 'score_weight' or key == 'r' or key == 'multi_image', "MPLUGOwl2Config does not support setting items other than multi_scale,score_weight,r,multi_image"
